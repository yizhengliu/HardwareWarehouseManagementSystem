...
namespace HardwareWarehouseManagementSystem
{
    internal class Program
    {
        ...
        {
            CustumQueue<HardwareItem> hardwareItemQueue = new CustumQueue<HardwareItem>();
        ...
        private static void ProcessItems(CustumQueue<HardwareItem> customQueue) 
        { 
        ...
        private static void CustomQueue_CustomQueueEvent(CustumQueue<HardwareItem> sender, QueueEventArgs eventArgs)
        {
            Console.Clear();
        ...
        private static void WriteValuesInQueueToScreen(CustumQueue<HardwareItem> hardwareItems) 
        {
    ...
    public abstract class HardwareItem : IEntityAdditionalProperties, IEntityPrimaryProperties
    {
